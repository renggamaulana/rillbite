...
import { FaUser, FaSignOutAlt, FaHeart, FaCalendarAlt, FaCog, FaSignInAlt, FaUserPlus, FaPlus } from "react-icons/fa";
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              {isAdmin && (
                <>
                  ...
                  <ul className="space-y-2 mb-4">
                    <li>
                      <Link onClick={onClose} href="/admin/add-recipe">
                        <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-purple-50 text-purple-700 hover:bg-purple-100 transition-all">
